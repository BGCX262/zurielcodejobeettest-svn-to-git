...
/*----------------------------------------------------------------------------------------------------------------------------------------
VERIFICA QUE EL MÉTODO getCompanySlug() Y EL REALIZAR EL slugify DEL ATRIBUTO COMPANÍA SEAN IGUALES.
----------------------------------------------------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------------------------------------------------
SI NO SE ESPECIFICA UNA FECHA DE EXPIRACIÓN, AUTOMATICAMENTE SE ESTABLECE UNA FECHA OBTENIDA DE LA VARIABLE DE CONFIG. app_active_days
----------------------------------------------------------------------------------------------------------------------------------------*/
$t->comment('->save()');
$job = create_job();
$job->save();
...
/*----------------------------------------------------------------------------------------------------------------------------------------
SI SE ESPECIFICA LA FECHA DE EXPIRACIÓN, ESTA NO DEBERÍA DE SER MODIFICADA
----------------------------------------------------------------------------------------------------------------------------------------*/ 
